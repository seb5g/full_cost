...
urlpatterns = [
    ...
    path('record/load-experiments/', views.LoadExperiments.as_view(), name='ajax_load_experiments'),
    path('record/load-sessions/', views.LoadSessions.as_view(), name='ajax_load_sessions'),
    ]
